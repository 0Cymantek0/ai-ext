      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center p-6 text-center overflow-y-auto scrollbar-custom">
        <div className="mb-8 space-y-4">
          ...
          <div className="space-y-4 text-center">
            ...
            >
              <span className="text-[0.85em]">Your</span>{" "}
              <FlipWords
            ...
            <p className="text-base text-muted-foreground max-w-lg mx-auto opacity-40">
              for capturing, organizing, and analyzing web content. Ask me
              anything or try one of these suggestions:
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span>
            Press{" "}
            <kbd className="px-1.5 py-0.5 rounded bg-muted/80 backdrop-blur-sm font-mono text-[10px]">
              Enter
            </kbd>{" "}
            to send,{" "}
            <kbd className="px-1.5 py-0.5 rounded bg-muted/80 backdrop-blur-sm font-mono text-[10px]">
