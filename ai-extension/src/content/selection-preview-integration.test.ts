...
describe('Selection Preview UI - Integration Tests', () => {
  ...
  beforeEach(() => {
    ...
    document.querySelectorAll('#ai-pocket-selection-preview, #ai-pocket-preview-backdrop').forEach(el => el.remove());
  });
  ...
  describe('Preview Display', () => {
    it('should display preview UI with valid selection', () => {
      ...
      const textarea = document.getElementById('ai-pocket-preview-textarea') as HTMLTextAreaElement;
  ...
  describe('User Interactions', () => {
    it('should call onSave when save button is clicked', () => {
      ...
      const hiddenContainer = document.getElementById('ai-pocket-selection-preview');
    ...
    it('should allow editing text in textarea', () => {
      ...
      previewUI.show(preview, validation, { onSave, onCancel: vi.fn(), onEdit });
    ...
    it('should disable save button when validation fails', () => {
      ...
      const container = document.getElementById('ai-pocket-selection-preview');
      const saveButton = Array.from(container?.querySelectorAll('button') || [])
        .find(btn => btn.textContent === 'Save to Pocket') as HTMLButtonElement;
  ...
  describe('Cleanup', () => {
    it('should remove all elements when hidden', () => {
      ...
      expect(document.getElementById('ai-pocket-selection-preview')).toBeTruthy();
      expect(document.getElementById('ai-pocket-preview-backdrop')).toBeTruthy();

      // Hide preview
      previewUI.hide();

      // Verify elements are removed
      expect(document.getElementById('ai-pocket-selection-preview')).toBeFalsy();
    ...
    it('should handle multiple show/hide cycles', () => {
      ...
      // First cycle
      previewUI.show(preview, validation, { onSave: vi.fn(), onCancel: vi.fn() });
      expect(document.getElementById('ai-pocket-selection-preview')).toBeTruthy();
      previewUI.hide();
      expect(document.getElementById('ai-pocket-selection-preview')).toBeFalsy();
