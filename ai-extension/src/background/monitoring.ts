...
export class Logger {
   ...
   */
  getLogs(minLevel?: LogLevel, category?: string, limit?: number): LogEntry[] {
...
export class PerformanceMonitor {
  ...
  private checkMemoryThreshold(): void {
    ...
    if (usedMemory > this.MEMORY_THRESHOLD) {
      this.logger.warn("PerformanceMonitor", "Memory usage exceeds threshold", {
  ...
  private async loadMetrics(): Promise<void> {
    try {
      ...
      this.logger.error("PerformanceMonitor", "Failed to load metrics", error);
    }
  }
