...
const mockModelSheet = {
  'gpt-4': { modelId: 'gpt-4', providerId: 'provider_1', providerType: 'openai', enabled: true },
  'gpt-3.5': { modelId: 'gpt-3.5', providerId: 'provider_1', providerType: 'openai', enabled: true },
  'claude': { modelId: 'claude', providerId: 'provider_2', providerType: 'anthropic', enabled: true },
};
